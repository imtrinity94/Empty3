/// <reference path="Intrinsics-1.0.0.d.ts"/>
	...
	interface KeyPairManager
	{
		...
		changePassphrase(path?: Path, oldPasspharse?: SecureString, newPassphrase?: SecureString): void;
		generateKeyPair(type?: String, path?: Path, passphrase?: SecureString, keySize?: Number, comment?: String): String;
	}
